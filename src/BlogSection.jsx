        ...
        <div className="grid grid-cols-1 gap-y-8 md:gap-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-[24.3px]">
            ...
            <div className="relative flex flex-col justify-center p-6 md:p-[24px] rounded-[24px] w-full md:w-[725px] h-auto md:h-[333px]" style={{ backgroundColor: '#DFF384' }}>
              ...
              <button className="text-white font-urbanist font-normal text-base md:text-[18px] py-2 px-6  self-start rounded-full " style={{ backgroundColor: '#0655A0' }}>
                LEARN MORE
              </button>
            </div>
          </div>
          ...
          {/* Blog Post 2 */}
          <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-6 md:gap-[24.3px]">
            <div className="relative flex flex-col justify-center p-6 md:p-[24px] rounded-[24px] w-full md:w-[725px] h-auto md:h-[333px]" style={{ backgroundColor: '#DFF384' }}>
              <h3 className="font-semibold text-3xl md:text-[56px] font-cormorant mb-4" >Personalized Consultation</h3>
              <p className="text-[#2E2E2E] text-lg md:text-[28px] font-lato mb-6">
              ...
              <button className="text-white font-urbanist font-normal text-base md:text-[18px] py-2 px-6 rounded-full self-start" style={{ backgroundColor: '#0655A0' }}>
                LEARN MORE
              </button>
            </div>
            <div className="w-full md:w-auto">
