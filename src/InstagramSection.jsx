...
const InstagramSection = () => (
  <section className="w-full flex justify-center py-12 px-2 md:px-0 bg-[#EAF1F8] animate-fadeInUp">
    <div className="w-full max-w-3xl rounded-3xl bg-white shadow-lg p-4 md:p-10 flex flex-col items-center hover:card-pop transition-transform">
      {/* Profile Info */}
      <div className="flex flex-col md:flex-row items-center md:items-start w-full gap-6 md:gap-10 mb-8">
        {/* Profile Image */}
        ...
        <div className="flex-1 flex flex-col items-center md:items-start">
          ...
          <div className="flex gap-6 mt-4 text-[black] font-lato text-base md:text-lg">
          ...
          <div className="mt-4 text-[black] font-lato text-base md:text-lg text-center md:text-left">
